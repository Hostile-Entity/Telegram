...
import org.telegram_ig21.messenger.support.LongSparseLongArray;
...
import org.telegram_ig21.ui.EditWidgetActivity;
...
public class MessagesController extends BaseController implements NotificationCenter.NotificationCenterDelegate {
    ...
    public void updateConfig(final TLRPC.TL_config config) {
        AndroidUtilities.runOnUIThread(() -> {
            ...
            if (config.static_maps_provider == null) {
                config.static_maps_provider = "telegram_ig21";
            }
            ...
            for (int a = 0; a < providers.length; a++) {
                ...
                if (mapArgs.length > 0) {
                    ...
                    if (typeAndKey.length > 0) {
                        ...
                        } else if ("telegram_ig21".equals(typeAndKey[0])) {
                            if (a == 0) {
                                mapProvider = 2;
                            }
    ...
    public void toogleChatForwards(long chatId, boolean enabled) {
