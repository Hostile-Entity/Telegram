...
package org.telegram_ig21.messenger;
...
import org.telegram_ig21.ui.Components.ForegroundDetector;
...
import org.telegram_ig21.ui.Components.PickerBottomLayout;
...
import org.telegram_ig21.ui.WallpapersListActivity;
                ...
                if (scheme != null) {
                    if ((scheme.equals("http") || scheme.equals("https"))) {
                        ...
                        if (url.startsWith("tg:proxy") || url.startsWith("tg://proxy") || url.startsWith("tg:socks") || url.startsWith("tg://socks")) {
                            url = url.replace("tg:proxy", "tg://telegram_ig21.org").replace("tg://proxy", "tg://telegram_ig21.org").replace("tg://socks", "tg://telegram_ig21.org").replace("tg:socks", "tg://telegram_ig21.org");
                            data = Uri.parse(url);
                            address = data.getQueryParameter("server");
                            if (AndroidUtilities.checkHostForPunycode(address)) {
                                address = IDN.toASCII(address, IDN.ALLOW_UNASSIGNED);
