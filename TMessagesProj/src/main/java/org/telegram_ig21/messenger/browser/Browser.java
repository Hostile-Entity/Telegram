...
package org.telegram_ig21.messenger.browser;
...
import org.telegram_ig21.messenger.CustomTabsCopyReceiver;
...
import org.telegram_ig21.messenger.ShareBroadcastReceiver;
import org.telegram_ig21.messenger.SharedConfig;
import org.telegram_ig21.messenger.UserConfig;
import org.telegram_ig21.messenger.support.customtabs.CustomTabsCallback;
import org.telegram_ig21.messenger.support.customtabs.CustomTabsClient;
import org.telegram_ig21.messenger.support.customtabs.CustomTabsIntent;
import org.telegram_ig21.messenger.support.customtabs.CustomTabsServiceConnection;
import org.telegram_ig21.messenger.support.customtabs.CustomTabsSession;
import org.telegram_ig21.messenger.support.customtabsclient.shared.CustomTabsHelper;
import org.telegram_ig21.messenger.support.customtabsclient.shared.ServiceConnection;
import org.telegram_ig21.messenger.support.customtabsclient.shared.ServiceConnectionCallback;
...
public class Browser {
    ...
    public static void openUrl(final Context context, Uri uri, final boolean allowCustom, boolean tryTelegraph) {
        ...
        if (tryTelegraph) {
            try {
                ...
                if (isTelegraphUrl(host, true) || uri.toString().toLowerCase().contains("telegram_ig21.org/faq") || uri.toString().toLowerCase().contains("telegram_ig21.org/privacy")) {
    ...
    public static boolean isInternalUri(Uri uri, boolean all, boolean[] forceBrowser) {
        ...
        if ("ton".equals(uri.getScheme())) {
            ...
            return true;
        } else if ("telegram_ig21.dog".equals(host)) {
        ...
        } else if ("telegram_ig21.me".equals(host) || "t.me".equals(host)) {
            String path = uri.getPath();
            if (path != null && path.length() > 1) {
                if (all) {
                    return true;
            ...
            if (host.endsWith("telegram_ig21.org") || host.endsWith("telegra.ph") || host.endsWith("telesco.pe")) {
                return true;
            }
        }
        return false;
