...
import org.telegram_ig21.PhoneFormat.PhoneFormat;
import org.telegram_ig21.messenger.AccountInstance;
import org.telegram_ig21.messenger.AndroidUtilities;
import org.telegram_ig21.messenger.ApplicationLoader;
import org.telegram_ig21.messenger.BuildVars;
import org.telegram_ig21.messenger.ChatObject;
import org.telegram_ig21.messenger.ContactsController;
import org.telegram_ig21.messenger.ContactsLoadingObserver;
import org.telegram_ig21.messenger.DialogObject;
import org.telegram_ig21.messenger.FileLoader;
import org.telegram_ig21.messenger.FileLog;
import org.telegram_ig21.messenger.ImageLoader;
import org.telegram_ig21.messenger.LocaleController;
import org.telegram_ig21.messenger.LocationController;
import org.telegram_ig21.messenger.MediaController;
import org.telegram_ig21.messenger.MediaDataController;
import org.telegram_ig21.messenger.MessageObject;
import org.telegram_ig21.messenger.MessagesController;
import org.telegram_ig21.messenger.MessagesStorage;
import org.telegram_ig21.messenger.NotificationCenter;
import org.telegram_ig21.messenger.R;
import org.telegram_ig21.messenger.SendMessagesHelper;
import org.telegram_ig21.messenger.SharedConfig;
import org.telegram_ig21.messenger.UserConfig;
import org.telegram_ig21.messenger.UserObject;
import org.telegram_ig21.messenger.Utilities;
import org.telegram_ig21.messenger.browser.Browser;
import org.telegram_ig21.messenger.camera.CameraController;
import org.telegram_ig21.messenger.voip.VideoCapturerDevice;
import org.telegram_ig21.messenger.voip.VoIPPendingCall;
import org.telegram_ig21.messenger.voip.VoIPService;
import org.telegram_ig21.tgnet.ConnectionsManager;
import org.telegram_ig21.tgnet.TLObject;
import org.telegram_ig21.tgnet.TLRPC;
import org.telegram_ig21.ui.ActionBar.ActionBarLayout;
import org.telegram_ig21.ui.ActionBar.AlertDialog;
import org.telegram_ig21.ui.ActionBar.BaseFragment;
import org.telegram_ig21.ui.ActionBar.DrawerLayoutContainer;
import org.telegram_ig21.ui.ActionBar.SimpleTextView;
import org.telegram_ig21.ui.ActionBar.Theme;
import org.telegram_ig21.ui.Adapters.DrawerLayoutAdapter;
import org.telegram_ig21.ui.Cells.DrawerAddCell;
import org.telegram_ig21.ui.Cells.DrawerProfileCell;
import org.telegram_ig21.ui.Cells.DrawerUserCell;
import org.telegram_ig21.ui.Cells.LanguageCell;
import org.telegram_ig21.ui.Components.AlertsCreator;
import org.telegram_ig21.ui.Components.AudioPlayerAlert;
import org.telegram_ig21.ui.Components.BlockingUpdateView;
import org.telegram_ig21.ui.Components.Bulletin;
import org.telegram_ig21.ui.Components.BulletinFactory;
import org.telegram_ig21.ui.Components.CubicBezierInterpolator;
import org.telegram_ig21.ui.Components.Easings;
import org.telegram_ig21.ui.Components.EmbedBottomSheet;
import org.telegram_ig21.ui.Components.GroupCallPip;
import org.telegram_ig21.ui.Components.JoinGroupAlert;
import org.telegram_ig21.ui.Components.LayoutHelper;
import org.telegram_ig21.ui.Components.MediaActionDrawable;
import org.telegram_ig21.ui.Components.PasscodeView;
import org.telegram_ig21.ui.Components.PhonebookShareAlert;
import org.telegram_ig21.ui.Components.PipRoundVideoView;
import org.telegram_ig21.ui.Components.RLottieDrawable;
import org.telegram_ig21.ui.Components.RLottieImageView;
import org.telegram_ig21.ui.Components.RadialProgress2;
import org.telegram_ig21.ui.Components.RecyclerListView;
import org.telegram_ig21.ui.Components.SharingLocationsAlert;
import org.telegram_ig21.ui.Components.SideMenultItemAnimator;
import org.telegram_ig21.ui.Components.SizeNotifierFrameLayout;
import org.telegram_ig21.ui.Components.StickerSetBulletinLayout;
import org.telegram_ig21.ui.Components.StickersAlert;
import org.telegram_ig21.ui.Components.TermsOfServiceView;
import org.telegram_ig21.ui.Components.ThemeEditorView;
import org.telegram_ig21.ui.Components.UndoView;
import org.telegram_ig21.ui.Components.UpdateAppAlertDialog;
import org.telegram_ig21.ui.Components.voip.VoIPHelper;
    ...
    private boolean handleIntent(Intent intent, boolean isNew, boolean restore, boolean fromPassword) {
        ...
        if ((flags & Intent.FLAG_ACTIVITY_LAUNCHED_FROM_HISTORY) == 0) {
            if (intent != null && intent.getAction() != null && !restore) {
                ...
                } else if ("org.telegram_ig21.messenger.CREATE_STICKER_PACK".equals(intent.getAction())) {
                    try {
                        ...
                        if (scheme != null) {
                            switch (scheme) {
                                ...
                                case "https": {
                                    ...
                                    if (host.equals("telegram_ig21.me") || host.equals("t.me") || host.equals("telegram_ig21.dog")) {
                                ...
                                case "tg": {
                                    ...
                                    if (url.startsWith("tg:resolve") || url.startsWith("tg://resolve")) {
                                        url = url.replace("tg:resolve", "tg://telegram_ig21.org").replace("tg://resolve", "tg://telegram_ig21.org");
                                        data = Uri.parse(url);
                                        ...
                                        url = url.replace("tg:privatepost", "tg://telegram_ig21.org").replace("tg://privatepost", "tg://telegram_ig21.org");
                                        data = Uri.parse(url);
                                        messageId = Utilities.parseInt(data.getQueryParameter("post"));
                                        ...
                                        url = url.replace("tg:bg", "tg://telegram_ig21.org").replace("tg://bg", "tg://telegram_ig21.org");
                                        data = Uri.parse(url);
                                        wallPaper = new TLRPC.TL_wallPaper();
                                        wallPaper.settings = new TLRPC.TL_wallPaperSettings();
                                        ...
                                        url = url.replace("tg:join", "tg://telegram_ig21.org").replace("tg://join", "tg://telegram_ig21.org");
                                        data = Uri.parse(url);
                                        group = data.getQueryParameter("invite");
                                    } else if (url.startsWith("tg:addstickers") || url.startsWith("tg://addstickers")) {
                                        url = url.replace("tg:addstickers", "tg://telegram_ig21.org").replace("tg://addstickers", "tg://telegram_ig21.org");
                                        data = Uri.parse(url);
                                        ...
                                        url = url.replace("tg:msg", "tg://telegram_ig21.org").replace("tg://msg", "tg://telegram_ig21.org").replace("tg://share", "tg://telegram_ig21.org").replace("tg:share", "tg://telegram_ig21.org");
                                        data = Uri.parse(url);
                                        message = data.getQueryParameter("url");
                                        if (message == null) {
                                            message = "";
                                        ...
                                        url = url.replace("tg:confirmphone", "tg://telegram_ig21.org").replace("tg://confirmphone", "tg://telegram_ig21.org");
                                        data = Uri.parse(url);

                                        phone = data.getQueryParameter("phone");
                                        phoneHash = data.getQueryParameter("hash");
                                    } else if (url.startsWith("tg:login") || url.startsWith("tg://login")) {
                                        url = url.replace("tg:login", "tg://telegram_ig21.org").replace("tg://login", "tg://telegram_ig21.org");
                                        data = Uri.parse(url);
                                        ...
                                        url = url.replace("tg:openmessage", "tg://telegram_ig21.org").replace("tg://openmessage", "tg://telegram_ig21.org");
                                        data = Uri.parse(url);
                                        ...
                                        url = url.replace("tg:passport", "tg://telegram_ig21.org").replace("tg://passport", "tg://telegram_ig21.org").replace("tg:secureid", "tg://telegram_ig21.org");
                                        data = Uri.parse(url);
                                        auth = new HashMap<>();
                                        String scope = data.getQueryParameter("scope");
                                        if (!TextUtils.isEmpty(scope) && scope.startsWith("{") && scope.endsWith("}")) {
                                        ...
                                        url = url.replace("tg:setlanguage", "tg://telegram_ig21.org").replace("tg://setlanguage", "tg://telegram_ig21.org");
                                        data = Uri.parse(url);
                                        lang = data.getQueryParameter("lang");
                                    } else if (url.startsWith("tg:addtheme") || url.startsWith("tg://addtheme")) {
                                        url = url.replace("tg:addtheme", "tg://telegram_ig21.org").replace("tg://addtheme", "tg://telegram_ig21.org");
                                        data = Uri.parse(url);
                                        ...
                                        url = url.replace("tg:search", "tg://telegram_ig21.org").replace("tg://search", "tg://telegram_ig21.org");
                                        data = Uri.parse(url);
                                        ...
                                        url = url.replace("tg:addcontact", "tg://telegram_ig21.org").replace("tg://addcontact", "tg://telegram_ig21.org");
                                        data = Uri.parse(url);
                                ...
                                try (Cursor cursor = getContentResolver().query(intent.getData(), null, null, null, null)) {
                                    if (cursor != null) {
                                        if (cursor.moveToFirst()) {
                                            ...
                                            if (TextUtils.equals(mimeType, "vnd.android.cursor.item/vnd.org.telegram_ig21.messenger.android.call")) {
                                                audioCallUser = true;
                                            } else if (TextUtils.equals(mimeType, "vnd.android.cursor.item/vnd.org.telegram_ig21.messenger.android.call.video")) {
                                                videoCallUser = true;
                                            }
                                        }
                                    }
                ...
                } else if (intent.getAction().equals("org.telegram_ig21.messenger.OPEN_ACCOUNT")) {
                    open_settings = 1;
