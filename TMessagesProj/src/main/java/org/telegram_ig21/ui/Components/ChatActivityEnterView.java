...
import org.telegram_ig21.ui.GroupStickersActivity;
import org.telegram_ig21.ui.LaunchActivity;
import org.telegram_ig21.ui.PhotoViewer;
import org.telegram_ig21.ui.StickersActivity;
        ...
        if (recordingAudioVideo) {
            ...
            try {
                if (wakeLock == null) {
                    ...
                    wakeLock = pm.newWakeLock(PowerManager.SCREEN_DIM_WAKE_LOCK | PowerManager.ON_AFTER_RELEASE, "telegram_ig21:audio_record_lock");
                    wakeLock.acquire();
                }
            } catch (Exception e) {
                FileLog.e(e);
